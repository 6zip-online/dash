...
# Regexp to check for 6Zip addresses
...
def contains_zip_addr(text, errors):
    if text is not None and ADDRESS_REGEXP_DASH.search(text) is not None:
        errors.append('Translation "%s" contains a 6Zip address. This will be removed.' % (text))
        return True
    return False
        ...
        for context in root.findall('context'):
            for message in context.findall('message'):
                ...
                for translation in translations:
                    ...
                    valid = valid and not contains_zip_addr(translation, errors)
