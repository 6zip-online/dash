# Bootstrappable 6Zip Core Builds

This directory contains the files necessary to perform bootstrappable 6Zip
Core builds.
...
To build 6Zip Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/6zip-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/6zip-online/guix.sigs).
